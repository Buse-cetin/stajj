...
class Degerlendirme(models.Model):
    staj_defteri = models.BooleanField("Staj",default=False,null=True)
    staj_evragi = models.BooleanField("Staj Evrağı",default=False,null=True)
    staj_basvuru_formu = models.BooleanField("Staj Başvuru Formu",default=False,null=True)
    staj_not = models.IntegerField("Not",default=False,null=True)
...
class OgrenciBilgi(models.Model):
    ...
    basvurudosyasi = models.BooleanField("Başvuru Dosyası",default=False,null=True)
    ...
    ogretmen = models.ForeignKey(Ogretmen, on_delete=models.CASCADE, null = True)
